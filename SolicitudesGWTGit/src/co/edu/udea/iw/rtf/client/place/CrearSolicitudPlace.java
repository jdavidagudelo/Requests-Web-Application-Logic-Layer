 ...
 */
public class CrearSolicitudPlace extends Place {
	...
	public CrearSolicitudPlace(String token) {
		this.name = token;
	}
	...
	public static class Tokenizer implements
			PlaceTokenizer<CrearSolicitudPlace> {

		@Override
		public String getToken(CrearSolicitudPlace place) {
			return place.getName();
		}

		@Override
		public CrearSolicitudPlace getPlace(String token) {
			return new CrearSolicitudPlace(token);
		}
